...
function Home() {
  ...
  useEffect(() => {
    intervalRef.current = setInterval(handleNext, 2000); // Change image every 5 seconds
 ...
 {/* Services Icons */}
  <div className="flex justify-center space-x-12"> {/* Increased space between items */}
  ...
  <div className="flex flex-col items-center">
    <div className="w-32 h-32 bg-[#1B3855] rounded-full overflow-hidden flex items-center justify-center shadow-md mb-6 transition-transform transform hover:scale-105">
      <img src="/image3.jpg" alt="Export Trade" className="h-full w-full object-cover" />
    </div>
  ...
  <div className="flex flex-col items-center">
    ...
    <p className="text-gray-600 mb-4 max-w-xs text-center">
      Our agriculture and food processing services help to enhance the value of farm produce in many aspect.
    </p>
    <button className="bg-[#1B3855] text-white py-2 px-6 rounded-full hover:bg-[#0E74A4] transition w-full">Read More</button>
  </div>
</div>
